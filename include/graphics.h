...
extern const u32 gMonFrontPic_MegaWalrein[];
extern const u32 gMonBackPic_MegaWalrein[];
extern const u32 gMonPalette_MegaWalrein[];
extern const u32 gMonShinyPalette_MegaWalrein[];
extern const u8 gMonIcon_MegaWalrein[];
extern const u32 gMonFrontPic_MegaMilotic[];
extern const u32 gMonBackPic_MegaMilotic[];
extern const u32 gMonPalette_MegaMilotic[];
extern const u32 gMonShinyPalette_MegaMilotic[];
extern const u8 gMonIcon_MegaMilotic[];
extern const u32 gMonFrontPic_MegaCrobat[];
extern const u32 gMonBackPic_MegaCrobat[];
extern const u32 gMonPalette_MegaCrobat[];
extern const u32 gMonShinyPalette_MegaCrobat[];
extern const u8 gMonIcon_MegaCrobat[];
extern const u32 gMonFrontPic_MegaDragonite[];
extern const u32 gMonBackPic_MegaDragonite[];
extern const u32 gMonPalette_MegaDragonite[];
extern const u32 gMonShinyPalette_MegaDragonite[];
extern const u8 gMonIcon_MegaDragonite[];
extern const u32 gMonFrontPic_MegaHaxorus[];
extern const u32 gMonBackPic_MegaHaxorus[];
extern const u32 gMonPalette_MegaHaxorus[];
extern const u32 gMonShinyPalette_MegaHaxorus[];
extern const u8 gMonIcon_MegaHaxorus[];
extern const u32 gMonFrontPic_MegaMeganium[];
extern const u32 gMonBackPic_MegaMeganium[];
extern const u32 gMonPalette_MegaMeganium[];
extern const u32 gMonShinyPalette_MegaMeganium[];
extern const u8 gMonIcon_MegaMeganium[];
extern const u32 gMonFrontPic_MegaFeraligatr[];
extern const u32 gMonBackPic_MegaFeraligatr[];
extern const u32 gMonPalette_MegaFeraligatr[];
extern const u32 gMonShinyPalette_MegaFeraligatr[];
extern const u8 gMonIcon_MegaFeraligatr[];
extern const u32 gMonFrontPic_MegaTyphlosion[];
extern const u32 gMonBackPic_MegaTyphlosion[];
