const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_MEGA_WALREIN] = _("Walrein"),
    [SPECIES_MEGA_MILOTIC] = _("Milotic"),
    [SPECIES_MEGA_CROBAT] = _("Crobat"),
    [SPECIES_MEGA_DRAGONITE] = _("Dragonite"),
    [SPECIES_MEGA_HAXORUS] = _("Haxorus"),
