const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_MEGA_DUSKNOIR] = sDusknoirLevelUpLearnset,
    [SPECIES_MEGA_WALREIN] = sWalreinLevelUpLearnset,
    [SPECIES_MEGA_MILOTIC] = sMiloticLevelUpLearnset,
    [SPECIES_MEGA_CROBAT] = sCrobatLevelUpLearnset,
    [SPECIES_MEGA_DRAGONITE] = sDragoniteLevelUpLearnset,
    [SPECIES_MEGA_HAXORUS] = sHaxorusLevelUpLearnset,
    [SPECIES_MEGA_MEGANIUM] = sMeganiumLevelUpLearnset,
    [SPECIES_MEGA_FERALIGATR] = sFeraligatrLevelUpLearnset,
    [SPECIES_MEGA_TYPHLOSION] = sTyphlosionLevelUpLearnset,
    [SPECIES_MEGA_MACHAMP] = sMachampLevelUpLearnset,
    [SPECIES_MEGA_LUXRAY] = sLuxrayLevelUpLearnset,
	// Alolan Forms
