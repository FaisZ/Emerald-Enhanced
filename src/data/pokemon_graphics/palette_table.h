const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MEGA_DUSKNOIR, gMonPalette_MegaDusknoir),
    SPECIES_PAL(MEGA_WALREIN, gMonPalette_MegaWalrein),
    SPECIES_PAL(MEGA_MILOTIC, gMonPalette_MegaMilotic),
    SPECIES_PAL(MEGA_CROBAT, gMonPalette_MegaCrobat),
    SPECIES_PAL(MEGA_DRAGONITE, gMonPalette_MegaDragonite),
    SPECIES_PAL(MEGA_HAXORUS, gMonPalette_MegaHaxorus),
    SPECIES_PAL(MEGA_MEGANIUM, gMonPalette_MegaMeganium),
    SPECIES_PAL(MEGA_FERALIGATR, gMonPalette_MegaFeraligatr),
    SPECIES_PAL(MEGA_TYPHLOSION, gMonPalette_MegaTyphlosion),
    SPECIES_PAL(MEGA_MACHAMP, gMonPalette_MegaMachamp),
    SPECIES_PAL(MEGA_LUXRAY, gMonPalette_MegaLuxray),
