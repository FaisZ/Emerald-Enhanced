const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(MEGA_DUSKNOIR, gMonBackPic_MegaDusknoir),
    SPECIES_SPRITE(MEGA_WALREIN, gMonBackPic_MegaWalrein),
    SPECIES_SPRITE(MEGA_MILOTIC, gMonBackPic_MegaMilotic),
    SPECIES_SPRITE(MEGA_CROBAT, gMonBackPic_MegaCrobat),
    SPECIES_SPRITE(MEGA_DRAGONITE, gMonBackPic_MegaDragonite),
    SPECIES_SPRITE(MEGA_HAXORUS, gMonBackPic_MegaHaxorus),
    SPECIES_SPRITE(MEGA_MEGANIUM, gMonBackPic_MegaMeganium),
    SPECIES_SPRITE(MEGA_FERALIGATR, gMonBackPic_MegaFeraligatr),
    SPECIES_SPRITE(MEGA_TYPHLOSION, gMonBackPic_MegaTyphlosion),
    SPECIES_SPRITE(MEGA_MACHAMP, gMonBackPic_MegaMachamp),
    SPECIES_SPRITE(MEGA_LUXRAY, gMonBackPic_MegaLuxray),
