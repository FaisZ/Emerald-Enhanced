const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MEGA_DUSKNOIR, gMonShinyPalette_MegaDusknoir),
    SPECIES_SHINY_PAL(MEGA_WALREIN, gMonShinyPalette_MegaWalrein),
    SPECIES_SHINY_PAL(MEGA_MILOTIC, gMonShinyPalette_MegaMilotic),
    SPECIES_SHINY_PAL(MEGA_CROBAT, gMonShinyPalette_MegaCrobat),
    SPECIES_SHINY_PAL(MEGA_DRAGONITE, gMonShinyPalette_MegaDragonite),
    SPECIES_SHINY_PAL(MEGA_HAXORUS, gMonShinyPalette_MegaHaxorus),
    SPECIES_SHINY_PAL(MEGA_MEGANIUM, gMonShinyPalette_MegaMeganium),
    SPECIES_SHINY_PAL(MEGA_FERALIGATR, gMonShinyPalette_MegaFeraligatr),
    SPECIES_SHINY_PAL(MEGA_TYPHLOSION, gMonShinyPalette_MegaTyphlosion),
    SPECIES_SHINY_PAL(MEGA_MACHAMP, gMonShinyPalette_MegaMachamp),
    SPECIES_SHINY_PAL(MEGA_LUXRAY, gMonShinyPalette_MegaLuxray),
