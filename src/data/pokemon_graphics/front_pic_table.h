const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(MEGA_DUSKNOIR, gMonFrontPic_MegaDusknoir),
    SPECIES_SPRITE(MEGA_WALREIN, gMonFrontPic_MegaWalrein),
    SPECIES_SPRITE(MEGA_MILOTIC, gMonFrontPic_MegaMilotic),
    SPECIES_SPRITE(MEGA_CROBAT, gMonFrontPic_MegaCrobat),
    SPECIES_SPRITE(MEGA_DRAGONITE, gMonFrontPic_MegaDragonite),
    SPECIES_SPRITE(MEGA_HAXORUS, gMonFrontPic_MegaHaxorus),
    SPECIES_SPRITE(MEGA_MEGANIUM, gMonFrontPic_MegaMeganium),
    SPECIES_SPRITE(MEGA_FERALIGATR, gMonFrontPic_MegaFeraligatr),
    SPECIES_SPRITE(MEGA_TYPHLOSION, gMonFrontPic_MegaTyphlosion),
    SPECIES_SPRITE(MEGA_MACHAMP, gMonFrontPic_MegaMachamp),
    SPECIES_SPRITE(MEGA_LUXRAY, gMonFrontPic_MegaLuxray),
