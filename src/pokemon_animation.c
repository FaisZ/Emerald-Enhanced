...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_TIMBURR] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_DUSKNOIR] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_WALREIN] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_MILOTIC] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_CROBAT] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_DRAGONITE] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_HAXORUS] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_MEGANIUM] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_FERALIGATR] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_TYPHLOSION] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_MACHAMP] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_MEGA_LUXRAY] = BACK_ANIM_VERTICAL_SHAKE,
};
